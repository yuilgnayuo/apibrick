...
public class PipelineEngine {
    ...
    public Mono<WorkflowResult> execute(String flowId, FlowDefinition flowDefinition, StepContext context) {
        ...
        logger.info("Executing pipeline flowId={}, instanceId={}, tenantId={}", 
                   flowId, flowInstanceId, context.getTenantId());
        ...
        StepContext finalContext = context;
        return executeStepsSequentially(steps, context, 0)
            ...
            .map(stepResults -> {
                ...
                if (allSuccess) {
                    ...
                    Object finalResponse = finalContext.get("finalResponse");
